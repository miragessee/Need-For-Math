...
/// </summary>
public class CarRaceControl : MonoBehaviourPunCallbacks, IComparable<CarRaceControl> {
	...
	void Update () {
		...
		if (state == RaceState.RACING)
			...
			photonView.RPC ("CorrectedTimeAndPosition", RpcTarget.All, raceTime, currentPosition);
		}
	}
